...
- [2023/08]: Propose a novel **PE-RSITR** task and provide empirical studies（accepted by **TGRS**）! This work explores the **parameter-efficient transfer learning** for remote sensing image-text retrieval. It reduces **98.9\%** of fine-tuned parameters. Our performance exceeds traditional methods by **7\%**~**13\%**.
