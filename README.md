...
&ensp This work explores the **adapter-based parameter-efficient transfer learning** for remote sensing image-text retrieval. It reduces **98.9\%** of fine-tuned parameters. Our performance exceeds traditional methods by **7\%**~**13\%**.
